...
m0 <- lmer(lrt ~ sze*(spt+obj+grv)*orn + 
                         ...
                         data=KKL, REML=FALSE)
# Model converges with a warning (see below); results appear to be ok. 

# print(summary(m0), corr=FALSE)   
# but summary() generates a cat(list((...))) error I do not understand. Doug?
```
